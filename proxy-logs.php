...
if (isset($_GET['delete-all'])) {
    $query = $mysqli->query("DELETE FROM `qurik_logs` WHERE type='Proxy'");
}
?>
...
<table id="dt-basicbans" class="table table-bordered table-hover table-sm" width="100%">
									...
									<tbody>
<?php
$sql = $mysqli->query("SELECT id, ip, date, time, browser, browser_code, os, os_code, country, country_code, type FROM `qurik_logs` WHERE type='Proxy' ORDER by id DESC");
