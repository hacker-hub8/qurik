...
<?php
	...
	echo '<i>This feature is not available on this host.</i>';	
}
?>
								</div>
							</div>
...
?>
                ...
                <div class="col-md-12">
                    <h3 class="mt-none" style="color: #33ff00;">Host Information</h3>
                       ...
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									<p class="text-uppercase mar-btm text-sm" class="font20" style="color: #33ff00;">Domain IP</p>
...
?></p>
                       ...
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									<p class="text-uppercase mar-btm text-sm" class="font20" style="color: #33ff00;">Country</p>
...
?></p>
                       ...
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									<p class="text-uppercase mar-btm text-sm" class="font20" style="color: #33ff00;">Server Software</p>
...
?>
                       ...
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									<p class="text-uppercase mar-btm text-sm" class="font20" style="color: #33ff00;">ISP</p>
...
?></p>
					...
					<div class="row">
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									<p class="text-uppercase mar-btm text-sm" class="font20" style="color: #33ff00;">Server OS</p>
...
?>                                    
                       ...
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									<p class="text-uppercase mar-btm text-sm" class="font20" style="color: #33ff00;">PHP Version</p>
...
?></p>
                       ...
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									<p class="text-uppercase mar-btm text-sm" class="font20" style="color: #33ff00;">MySQL Version</p>
...
?></p>
                       ...
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									<p class="text-uppercase mar-btm text-sm" class="font20" style="color: #33ff00;">Server Port</p>
...
?></p>
					...
					<div class="row">
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									<p class="text-uppercase mar-btm text-sm" class="font20" style="color: #33ff00;">OpenSSL Version</p>
...
?></p>
                       ...
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									<p class="text-uppercase mar-btm text-sm" class="font20" style="color: #33ff00;">cURL Extension</p>
...
?></p>
                       ...
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									<p class="text-uppercase mar-btm text-sm" class="font20" style="color: #33ff00;">HTTP Protocol</p>
...
?></p>
                       ...
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									<p class="text-uppercase mar-btm text-sm" class="font20" style="color: #33ff00;">Gateway Interface</p>
...
?></p>
                ...
                <div class="col-md-12">
                            <div class="info-box bg-info">
                                ...
                                <div class="info-box-content">
									<span class="info-box-text">STORAGE FREE SPACE</span>
<?php
if (!function_exists("view_size")) {
    function view_size($size)
    {
...
?>
                                 ...
                                 <span class="info-box-number">Total Free: <?php
    echo view_size($free);
?></span>
