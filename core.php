...
?>" class="nav-link" target="_blank" data-toggle="tooltip" title="Visit Site" data-toggle="tooltip" data-placement="bottom">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<center><a href="dashboard.php" class="brand-link" style="color: #33ff00;">
 <bold><i class="fa fa-angle-double-right" aria-hidden="true"></i> Qurik  <i class="fa fa-angle-double-left" aria-hidden="true"></i>
 </bold>
	...
	<div class="sidebar">
      ...
      <div class="user-panel mt-3 d-flex align-content-center justify-content-center flex-wrap">
          <p class="margin_auto"><a href="account.php" class="btn btn-sm btn-secondary btn-flat"><i class="fas fa-user fa-fw"></i></a>
		  <a href="logout.php" class="btn btn-sm btn-danger btn-flat"><i class="fas fa-sign-out-alt fa-fw"></i></a></p>
      </div>

	  <nav class="mt-2">
	  <ul class="nav nav-pills nav-sidebar nav-compact flex-column" data-widget="treeview" role="menu">
      <li class="nav-header" style="color: #33ff00;"> Qurik-NAVIGATION</li>
...
?>">
              <i class="fas fa-history"></i>&nbsp; <p>Login Activity</p>
           </a>
        </li>

        <li class="nav-header" style="color: #33ff00;"> Qurik-SECURITY</li>
...
?></span></p></a></li>
		...
		<li class="nav-header" style="color: #33ff00;"> Qurik-SECURITY-CHECK</li>
        <li class="nav-item <?php
    if (basename($_SERVER['SCRIPT_NAME']) == 'warning-pages.php') {
        echo 'active';
    }
...
?>">
           <a href="php-info.php" class="nav-link <?php
    if (basename($_SERVER['SCRIPT_NAME']) == 'php-info.php') {
        echo 'active';
    }
?>">
		...
		<li class="nav-header" style="color: #33ff00;">Qurik-ANALYTICS &nbsp;
<?php
...
?>">
              <i class="fas fa-globe"></i>&nbsp; <p>Real-Time Traffic</p>
           </a>
        </li>
...
?>">
              <i class="fas fa-globe"></i>&nbsp; <p>Traffic (Lite)</p>
           </a>
        </li>
...
?>">
              <i class="fas fa-chart-line"></i>&nbsp; <p>Quirk Traffic Hub</p>
           </a>
        </li>
          
        <li class="nav-header" style="color: #33ff00;">Qurik-TOOLS</li>
...
?>">
              <i class="fas fa-exclamation-circle"></i>&nbsp; <p>Error Tracking</p>
           </a>
        </li>
...
?>">
              <i class="fas fa-columns"></i>&nbsp; <p>.htacces Manager</p>
           </a>
        </li>
...
?>">
              <i class="fas fa-search"></i>&nbsp; <p>Port Analyzer</p>
           </a>
        </li>
...
?>">
              <i class="fas fa-lock"></i>&nbsp; <p>Hash Generator</p>
           </a>
        </li>
...
?>
    ...
    // Check if fullscreen was previously activated
    ...
    document.addEventListener('fullscreenchange', function() {
        if (!document.fullscreenElement) {
            // If exiting fullscreen, re-enter fullscreen
            enterFullscreen();
        }
    });
});
